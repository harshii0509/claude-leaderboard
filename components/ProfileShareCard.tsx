...
import { formatCompactNumber } from '@/lib/profile-share'
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div style={{ fontSize: 18 * scale, color: palette.muted, fontWeight: 800, textTransform: 'uppercase', letterSpacing: 1 }}>
              Current vibe
            </div>
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 * scale }}>
            <div style={{ fontSize: 20 * scale, color: palette.muted, fontWeight: 800, textTransform: 'uppercase', letterSpacing: 1.2 }}>
